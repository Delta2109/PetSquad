...
public class MaterialAssignmentManager : ModuleRules
{
	public MaterialAssignmentManager(ReadOnlyTargetRules Target) : base(Target)
	{
		PCHUsage = ModuleRules.PCHUsageMode.UseExplicitOrSharedPCHs;

        PrivatePCHHeaderFile = "Public/MaterialAssignmentManager.h";
